...
/**
 * Компонент для отображения Vanta.js TOPOLOGY фона
 */
      ...
      import("vanta/dist/vanta.topology.min.js").then((module) => {
        ...
        if (TOPOLOGY && typeof TOPOLOGY === 'function') {
          try {
            ...
            console.error("Error initializing Vanta.js TOPOLOGY:", error);
          }
        } else {
          console.error("Vanta.js TOPOLOGY is not a function. Module structure:", module);
        }
      }).catch((err) => {
        console.error("Failed to load Vanta.js TOPOLOGY:", err);
      });
    };
